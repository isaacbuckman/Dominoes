...
def ismcts(rootstate, itermax=5000, time_limit=10, verbose=False, quiet=False):
    """
    ...
    if len(rootstate.get_moves()) > 1:
        ...
        while (time.time() - start_time) < time_limit:
            ...
            while state.get_moves() != [] and node.get_untried_moves(
                ...
                # print 'moving ', node.move
                # print 'ends ', state.ends
            ...
            # Simulate
            # print 'simulate ', i
            while not state.is_end():  # while state is non-terminal
                move = random.choice(state.get_moves())
                state.do_move(move)
                # print 'moving ', move
                # print 'curr_player ', state.curr_player
                # print 'ends ', state.ends
                # raw_input("")
